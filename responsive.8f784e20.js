...
},{"./_arrayMap":"BblM","./_baseIteratee":"lW7l","./_baseMap":"wrrS","./isArray":"p0cq"}],"DMuG":[function(require,module,exports) {
function r(r){for(var n=-1,e=null==r?0:r.length,l={};++n<e;){var o=r[n];l[o[0]]=o[1]}return l}module.exports=r;
},{}],"J7Ce":[function(require,module,exports) {
"use strict";var t=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.metaFlex=exports.getRootFontSize=exports.unusual=exports.DesignClientWidth=exports.RootFontSize=void 0;var e=t(require("lodash/map")),i=t(require("lodash/fromPairs"));function o(){if(navigator.appVersion.match(/(iphone|ipad|ipod)/gi))return!1;var t=navigator.userAgent.match(/Android[\S\s]+AppleWebkit\/(\d{3})/i);if(t&&parseInt(t[1],10)>534)return!1;var e=navigator.userAgent.match(/U3\/((\d+|\.){5,})/i);if(e&&parseInt(e[1].split(".").join(""),10)<80)return!0;return!1}function n(t,n){void 0===t&&(t=exports.RootFontSize),void 0===n&&(n=exports.DesignClientWidth);var r=document.querySelector('meta[name="viewport"]');r||((r=document.createElement("meta")).setAttribute("name","viewport"),document.head.appendChild(r));var a=1,s=r.getAttribute("content");if(s){var d=e.default(s.split(","),function(t){return t.split("=")});a=1*i.default(d)["initial-scale"]||1}var l=document.documentElement,u=l.clientWidth*a,p=n/u,c=o()?1:1/window.devicePixelRatio;return r.setAttribute("content","width=device-width,user-scalable=no,initial-scale="+c+",maximum-scale="+c+",minimum-scale="+c),u===l.clientWidth?t*l.clientWidth/n:t/p*window.devicePixelRatio}function r(t,e){void 0===t&&(t=exports.RootFontSize),void 0===e&&(e=exports.DesignClientWidth);var i=document.documentElement;i.style.fontSize=n(t,e)+"px",i.style.display="none",i.clientWidth,i.style.display=""}function a(t,e){return void 0===t&&(t=exports.RootFontSize),void 0===e&&(e=exports.DesignClientWidth),r(t,e)}exports.RootFontSize=16,exports.DesignClientWidth=750,exports.unusual=o,exports.getRootFontSize=n,exports.metaFlex=r,exports.default=a;
},{"lodash/map":"vGW8","lodash/fromPairs":"DMuG"}],"kWtH":[function(require,module,exports) {
"use strict";var e=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var t=e(require("./services/responsive"));window.addEventListener("resize",function(){return t.default()}),t.default();
},{"./services/responsive":"J7Ce"}]},{},["kWtH"], null)